...
if __name__ == "__main__":
    ...
    networkConfig_PathList = [f'{networkConfigRoot}/retrial_w_easier_dataset/fed_prox/config_fed_prox_3_layer_MD_RP_6.json',
                              f'{networkConfigRoot}/retrial_w_easier_dataset/fed_prox/config_fed_prox_3_layer_MD_RP_7.json',
                              f'{networkConfigRoot}/retrial_w_easier_dataset/fed_prox/config_fed_prox_3_layer_MD_RP_8.json']
