...
if __name__ == "__main__":
    ...
    networkConfig_PathList = [f'{networkConfigRoot}/domain_adaptation/config_da_fisherclient_2_0.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherclient_2_1.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherclient_2_2.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherclient_2_3.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherclient_2_4.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherserver_3_0.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherserver_3_1.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherserver_3_2.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherserver_3_3.json',
                              f'{networkConfigRoot}/domain_adaptation/config_da_fisherserver_3_4.json']
