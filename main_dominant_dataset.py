...
def runner(networkConfigPath, dataConfigPath):
    ...
    if basicConfig['dataset'][0] == "mnist":
        # 50000 out of 60000
        client_subset_ratio = 0.84
    elif basicConfig['dataset'][0] == "svhn":
        # 50000 out of 73257
        client_subset_ratio = 0.69

    clientDataset, serverTestDataset, classes = select_dataset(basicConfig['dataset'][0], client_subset_ratio, 1.0)
    ...
    server = Server(rootModel=modelToServer,
                    examinDataset_list=[serverTestDataset],
...
if __name__ == "__main__":
    ...
    '''
    networkConfig_PathList = [f'{networkConfigRoot}/fedAvg/config_fedAvg_0.json',
                              f'{networkConfigRoot}/fedAvg/config_fedAvg_1.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_0_0.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_0_1.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_0_2.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_0_3.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_1_0.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_1_1.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_1_2.json',
                              f'{networkConfigRoot}/fed_prox/config_fedprox_1_3.json']
