...
import json
import torch
from server.server_operator.server_feature_wise import serverFeatureWise
...
def runner(networkConfigPath, dataConfigPath):
    ...
    server = serverFeatureWise(rootModel=modelToServer,
...
if __name__ == "__main__":
    ...
    networkConfigRoot = './config/networkConfig/feature_wise_FL'
    dataConfigRoot = './config/datasetConfig'

    networkConfigPath_prefix = networkConfigRoot

    networkConfig_PathList = [f'{networkConfigPath_prefix}/fed_feature_wise_FL.json']
