...
import json
import torch
from server.server_operator.server_adaptive_fed import server_adaptive_fed
...
def runner(networkConfigPath, dataConfigPath):
    ...
    server = server_adaptive_fed(rootModel=modelToServer,
...
if __name__ == "__main__":
    ...
    networkConfig_PathList = [f'{networkConfigPath_prefix}/fed_adaptive_avg_2CP_noniid.json']
