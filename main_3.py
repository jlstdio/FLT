...
def runner(networkConfigPath, dataConfigPath):
    ...
    elif sharedConfig['model'] == 'resnet50':
        from model.resnet50 import ResNet50
        modelToLoad = ResNet50(numClasses)
    # ##################################################################
...
if __name__ == "__main__":
    ...
    networkConfig_PathList = [
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_8.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_6.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_7.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_1.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_2.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_3.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_4.json',
        f'{networkConfigRoot}/retrial_w_easier_dataset/partial_fed_prox/config_partial_fed_prox_3_layer_MD_RP_5.json']

    dataConfig_PathList = [f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_10types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_8types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_6types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_4types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_3types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_4types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_7types.json',
                           f'{dataConfigRoot}/dirichlet_by_num_of_types/dataConfig_dirichlet_7types.json']
